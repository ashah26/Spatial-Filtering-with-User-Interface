...
class Home extends Component{
            ...
            return (
                <div className="custom-control custom-radio">
                    <input type="radio" className="custom-control-input" id={filter_type} name="filter_type"
                           checked={this.state.selected_filter_type === filter_type}
                           onClick={(()=>{
                               this.setState({
                                   ...this.state,
    ...
    downloadImage = (()=>{
        if(this.state.filtered_image){
            var url = this.state.filtered_image.replace(/^data:image\/[^;]+/, 'data:application/octet-stream');
            window.open(url);
                        ...
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 className="modal-title" id="exampleModalLongTitle">Select Mask</h5>
